...
DefaultList<int> DefaultInts =
{
    ...
    {"3D.GL.TextureFilterMipDepth", RendererSettings::GetTextureFilterMipDepthIndex(RendererSettings::TextureFilterMipDepth::Full)},
    {"3D.GL.TextureScalingAlgorithm", RendererSettings::GetGLScaleAlgorithmIndex(RendererSettings::GLScaleAlgorithm::Spline36)},
    {"3D.GL.WholeScene2DScaleMode", RendererSettings::GetWholeScene2DScaleModeIndex(RendererSettings::WholeScene2DScaleMode::LegacyNativeUpscale)},
...
RangeList IntRanges =
{
    ...
    {"3D.GL.TextureScalingAlgorithm", {RendererSettings::GetGLScaleAlgorithmIndex(RendererSettings::GLScaleAlgorithm::Spline36), RendererSettings::GetGLScaleAlgorithmIndex(RendererSettings::GLScaleAlgorithm::NNEDI3)}},
    ...
    {"3D.GL.WholeScene2DScaleAlgorithm", {RendererSettings::GetGLScaleAlgorithmIndex(RendererSettings::GLScaleAlgorithm::Spline36), RendererSettings::GetGLScaleAlgorithmIndex(RendererSettings::GLScaleAlgorithm::NNEDI3)}},
...
DefaultList<bool> DefaultBools =
{
    ...
    {"3D.GL.TextureFilterMipmapSubrectHandling", false},
    {"3D.GL.TextureFilterMipmapAlphaHandling", false},
    {"3D.GL.TextureLosslessRGB6Repack", false},
    {"3D.GL.TextureScaling", false},
    {"3D.GL.TextureScalingArtCNN", false},
    {"3D.GL.TextureScalingFrequentChangePolicy", false},
    {"3D.GL.TextureScalingDeferred", false},
    {"3D.GL.TextureScalingNativeMipFloor", false},
    {"3D.GL.TextureScalingSourceMips", false},
    {"3D.GL.TextureScalingEdgeExtendUnusedMargins", true},
    ...
    {"3D.GL.WholeScene2DScaleArtCNN", false},
    {"3D.GL.WholeScene2DScaleExactFinalFallback", false},
    {"3D.GL.WholeScene2DScaleForegroundOverlay", false},
    {"3D.GL.WholeScene2DScaleCaptureBacked", false},
    {"3D.GL.WholeScene2DScaleDebugTint", false},
    {"3D.GL.WholeScene2DScaleNoWrapFilterTaps", true},
    {"3D.GL.WholeScene2DScaleFinalUpscaleRender3DNative", false},
    {"3D.GL.WholeScene2DScaleFinalUpscale3DCoverageAware", false},
    {"3D.GL.WholeScene2DScaleFinalUpscale3DRepresentativeSemantics", true},
    {"3D.GL.WholeScene2DScaleFinalUpscale3DSplitSemantics", false},
    {"3D.GL.WholeScene2DScaleFinalUpscale3DSharpenSplitCoverage", false},
    {"3D.GL.WholeScene2DScaleOverlayLegacyUnderlay", false},
    {"3D.GL.WholeScene2DScaleHybridWindowEdgeAssist", false},
    {"3D.GL.WholeScene2DScaleHybridTarget2AlphaBlendAssist", false},
    {"3D.GL.WholeScene2DScaleHybridNativeEffectGuard", false},
    {"3D.GL.WholeScene2DScaleHybridForeground2DBase", false},
    {"3D.GL.WholeScene2DScaleHybridCleanLegacyCandidate", false},
...
LegacyEntry LegacyFile[] =
{
    ...
    {"ScreenSharpen",       0, "Screen.Sharpen", false},
    {"ScreenSharpenStrength", 0, "Screen.SharpenStrength", false},
