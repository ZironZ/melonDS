...
DefaultList<bool> DefaultBools =
{
    ...
    {"3D.GL.WholeScene2DScaleCaptureBacked", true},
    ...
    {"3D.GL.WholeScene2DScaleFinalUpscale3DCoverageAware", true},
    {"3D.GL.WholeScene2DScaleFinalUpscale3DRepresentativeSemantics", false},
    {"3D.GL.WholeScene2DScaleFinalUpscale3DSplitSemantics", true},
    {"3D.GL.WholeScene2DScaleFinalUpscale3DSharpenSplitCoverage", false},
    {"3D.GL.WholeScene2DScaleOverlayLegacyUnderlay", false},
    {"3D.GL.WholeScene2DScaleHybridWindowEdgeAssist", true},
    {"3D.GL.WholeScene2DScaleHybridTarget2AlphaBlendAssist", true},
